...
const error = "_error_11aiz_17";
const styles$9 = {
  "input-number": "_input-number_11aiz_1",
  error
};
...
function InputNumber({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "input",
    {
      className: `${styles$9["input-number"]} ${errorMessage ? styles$9["error"] : DEFAULT_ERROR_MESSAGE}`,
      placeholder,
      value,
...
const styles$8 = {
  "input-description": "_input-description_zkncj_1"
};
function InputDescription({ inputValue }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$8["input-description"], children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: inputValue }) });
}
const styles$7 = {
  "input-subtitle": "_input-subtitle_1oe5e_1"
};
function InputSubtitle({ inputValue }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$7["input-subtitle"], children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: inputValue }) });
}
const CONSTANT_INPUT_TITLE = " 입력해 주세요.";
function InputTitle({ inputValue }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "input-title", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { children: [
    inputValue,
    CONSTANT_INPUT_TITLE
  ] }) });
}
const styles$6 = {
  "card-number": "_card-number_jpg1c_1",
  "card-number__input": "_card-number__input_jpg1c_7"
};
const styles$5 = {
  "input-error-message": "_input-error-message_1wl8m_1"
};
function InputErrorMessage({ message }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$5["input-error-message"], children: message });
}
...
function CardNumber({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: styles$6["card-number"], children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(InputTitle, { inputValue: CONSTANT_CARD_NUMBER.INPUT_TITLE }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(InputDescription, { inputValue: CONSTANT_CARD_NUMBER.INPUT_DESCRIPTION }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(InputSubtitle, { inputValue: CONSTANT_CARD_NUMBER.INPUT_SUBTITLE }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$6["card-number__input"], children: [0, 1, 2, 3].map((index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      InputNumber,
      {
...
const styles$4 = {
  "card-number__input": "_card-number__input_11c6t_1"
};
...
function CardExpirationDate({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "card-expiration-date", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(InputTitle, { inputValue: CONSTANT_EXPIRATION_DATE.INPUT_TITLE }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      InputDescription,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(InputSubtitle, { inputValue: CONSTANT_EXPIRATION_DATE.INPUT_SUBTITLE }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$4["card-number__input"], children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        InputNumber,
        {
...
function CardCvcNumber({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: styles$3["card-cvc"], children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(InputTitle, { inputValue: CONSTANT_CARD_CVC_NUMBER.INPUT_TITLE }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(InputSubtitle, { inputValue: CONSTANT_CARD_CVC_NUMBER.INPUT_SUBTITLE }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      InputNumber,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(InputErrorMessage, { message: errorMessage })
  ] });
}
const styles$2 = {
  "card-layout": "_card-layout_bg4wo_1",
  "card-chip": "_card-chip_bg4wo_10"
};
const styles$1 = {
  "card-logo": "_card-logo_z50o2_1"
};
const DEFAULT_CARD_TYPE = "default";
function PreviewCardLogo({
  cardType = DEFAULT_CARD_TYPE
}) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: styles$1["card-logo"], src: cardLogoImagePath(cardType) });
}
function cardLogoImagePath(cardType) {
  if (cardType === "default") return;
  return `./${cardType}-logo.png`;
}
const styles = {
  "card-layout-number-container": "_card-layout-number-container_m0ch8_1",
  "card-layout-number-wrapper": "_card-layout-number-wrapper_m0ch8_9",
  "card-layout-number": "_card-layout-number_m0ch8_1"
};
function PreviewCardNumber({
  cardNumbers,
  cardExpirationDate
}) {
  const expiration = cardExpirationDate[0] === "" ? `${cardExpirationDate[1]}` : `${cardExpirationDate[1]}/${cardExpirationDate[0]}`;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles["card-layout-number-container"], children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles["card-layout-number-wrapper"], children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles["card-layout-number"], children: cardNumbers[0] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles["card-layout-number"], children: cardNumbers[1] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles["card-layout-number"], children: "·".repeat(cardNumbers[2].length) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles["card-layout-number"], children: "·".repeat(cardNumbers[3].length) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles["card-layout-expiration-number"], children: expiration })
  ] });
}
function PreviewCardLayout({
  cardNumbers,
  cardType,
  cardExpirationDate
}) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2["card-layout"], children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2["card-chip"] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(PreviewCardLogo, { cardType }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      PreviewCardNumber,
      {
        cardNumbers,
...
function isValidLength(length, maxLength) {
...
function setErrorMessage(cardNumbersError, errorMessage, index, setError) {
...
function useExpirationDate() {
  const [cardExpirationDate, setcardExpirationDate] = reactExports.useState(["", ""]);
  const [cardExpirationDateError, setError] = reactExports.useState(["", ""]);
  const dateValidate = (value, index) => {
    ...
    if (index === 0 && value.length === CONSTANT_USE_EXPIRATION_DATE.MAX_LENGTH && !isValidMonth(Number(value))) {
      setErrorMessage(
        cardExpirationDateError,
...
function useCvcNumber() {
  const [cvcNumbers, setCardCvcNumbers] = reactExports.useState("");
  const [cvcNumbersError, setError] = reactExports.useState([""]);
  const cvcNumbersValidate = (value) => {
...
function useCardNumbers() {
  ...
  const [cardNumbersError, setError] = reactExports.useState(["", "", "", ""]);
  const [cardType, setCardType] = reactExports.useState("default");
  const cardNumbersValidate = (value, index) => {
...
function getCardType(firstTwoDigits) {
  if (firstTwoDigits >= CARD_TYPE.VISA.START_NUMBER && firstTwoDigits <= CARD_TYPE.VISA.END_NUMBER) {
    return CARD_TYPE.VISA.NAME;
  } else if (firstTwoDigits >= CARD_TYPE.MASTER.START_NUMBER && firstTwoDigits <= CARD_TYPE.MASTER.END_NUMBER) {
...
function App() {
  const { cardNumbers, cardType, cardNumbersError, cardNumbersValidate } = useCardNumbers();
  const { cardExpirationDate, cardExpirationDateError, dateValidate } = useExpirationDate();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "App", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-input", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        CardNumber,
        {
